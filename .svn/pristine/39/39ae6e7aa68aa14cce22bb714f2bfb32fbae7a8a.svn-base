...
public class HbaseDao {
    ...
    //Hbase内部封装的多线程插入
    public void multithreadingInsert(String table_name, List<Put> puts, int thread_num){
...
//        String tableName = "weather_txt";
     ...
     * @param _splitKeys
     */
    public void createTable(String tableName, byte[][] _splitKeys) {
        Admin admin = null;
        Connection conn = null;
        try {
            conn = ConnectionFactory.createConnection(hbaseTemplate.getConfiguration());
